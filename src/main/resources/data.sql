...
-- Operator
insert into TB_OPERATOR (ID_OPERATOR, NAME,LOGIN,PASSWORD,PERFIL,DT_REGISTER,ADMIN) values (1 , 'ADMINISTRADOR', 'admin', '$2a$10$SrOskWc2hyPQk69Zo3vxIe/WH4f8kpLg9SDCle0CsnzTCUl8yq4RW', 'GESTOR',sysdate,1);

--Operator 2
insert into TB_OPERATOR (ID_OPERATOR, NAME,LOGIN,PASSWORD,PERFIL,DT_REGISTER,ADMIN) values (2 , 'GESTOR', 'gestor', '$2a$10$nToTxLHHX/AQ2J5ZnXYXSOpcjbxzjA7CvrjJ/PooEN3ntcIVDIHHi', 'GESTOR',sysdate,0);
